...
specify init <project_name> --ai codeium
specify init <project_name> --ai tabnine
specify init <project_name> --ai codewhisperer
specify init <project_name> --ai ghostwriter
specify init <project_name> --ai codium
...
specify init <project_name> --ai cursor --ignore-agent-tools
specify init <project_name> --ai codeium --ignore-agent-tools
specify init <project_name> --ai tabnine --ignore-agent-tools
specify init <project_name> --ai codewhisperer --ignore-agent-tools
specify init <project_name> --ai ghostwriter --ignore-agent-tools
specify init <project_name> --ai codium --ignore-agent-tools
specify init <project_name> --ai iflow --ignore-agent-tools
```
